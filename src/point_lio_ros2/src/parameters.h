...
extern bool zupt_enable, zupt_position_hold_enable;
extern double zupt_gyro_threshold, zupt_acc_threshold;
extern double zupt_gyro_std_threshold, zupt_acc_std_threshold;
extern int zupt_window_size;
extern double zupt_min_stationary_time, zupt_velocity_cov, zupt_position_cov;
