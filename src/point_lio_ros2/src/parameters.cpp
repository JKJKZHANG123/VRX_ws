...
bool zupt_enable, zupt_position_hold_enable;
double zupt_gyro_threshold, zupt_acc_threshold;
double zupt_gyro_std_threshold, zupt_acc_std_threshold;
int zupt_window_size;
double zupt_min_stationary_time, zupt_velocity_cov, zupt_position_cov;
...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<bool>("mapping.zupt_enable", false);
    nh->declare_parameter<bool>("mapping.zupt_position_hold_enable", false);
    nh->declare_parameter<double>("mapping.zupt_gyro_threshold", 0.03);
    nh->declare_parameter<double>("mapping.zupt_acc_threshold", 0.20);
    nh->declare_parameter<double>("mapping.zupt_gyro_std_threshold", 0.01);
    nh->declare_parameter<double>("mapping.zupt_acc_std_threshold", 0.10);
    nh->declare_parameter<int>("mapping.zupt_window_size", 60);
    nh->declare_parameter<double>("mapping.zupt_min_stationary_time", 0.50);
    nh->declare_parameter<double>("mapping.zupt_velocity_cov", 0.01);
    nh->declare_parameter<double>("mapping.zupt_position_cov", 0.0025);
    ...
    nh->get_parameter("mapping.zupt_enable", zupt_enable);
    nh->get_parameter("mapping.zupt_position_hold_enable", zupt_position_hold_enable);
    nh->get_parameter("mapping.zupt_gyro_threshold", zupt_gyro_threshold);
    nh->get_parameter("mapping.zupt_acc_threshold", zupt_acc_threshold);
    nh->get_parameter("mapping.zupt_gyro_std_threshold", zupt_gyro_std_threshold);
    nh->get_parameter("mapping.zupt_acc_std_threshold", zupt_acc_std_threshold);
    nh->get_parameter("mapping.zupt_window_size", zupt_window_size);
    nh->get_parameter("mapping.zupt_min_stationary_time", zupt_min_stationary_time);
    nh->get_parameter("mapping.zupt_velocity_cov", zupt_velocity_cov);
    nh->get_parameter("mapping.zupt_position_cov", zupt_position_cov);
